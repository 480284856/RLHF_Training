...
def main(args):
    ...
    prompt_dataset = PromptDataset(tokenizer=tokenizer, data_path=args.prompt_path, max_datasets_size=-1)
    prompt_sampler = None
    ...
    pretrain_dataset = SupervisedDataset(tokenizer=tokenizer, data_path=args.pretrain_dataset, max_datasets_size=-1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='gpt2', choices=['gpt2', 'bloom', 'opt', 'llama', 'roberta'], help="gneral type of model, not model id in hf")
    parser.add_argument('--pretrain', type=str, default=None, help='path of pretrained state dict of model')
    parser.add_argument('--rm_model', default=None, choices=['gpt2', 'bloom', 'opt', 'llama', 'roberta'])
    parser.add_argument('--rm_path', type=str, default=None, help='path of pretrained rm state dict')
    parser.add_argument('--rm_pretrain', type=str, default=None, help="rm id in huggingface")
    parser.add_argument('--save_path', type=str, default='actor_checkpoint_prompts')
    parser.add_argument('--need_optim_ckpt', type=bool, default=False)
    parser.add_argument('--num_episodes', type=int, default=4)
    parser.add_argument('--max_timesteps', type=int, default=6500)
    parser.add_argument('--update_timesteps', type=int, default=100)
